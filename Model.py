...
def predict(image, num_return_sequnces):
    """
    ...
    num_beams = num_return_sequnces*2  # number of beams is taken as 2 * number of sequences
    num_beam_groups = num_return_sequnces
    num_return_sequences = num_return_sequnces
    temperature = 1.0
